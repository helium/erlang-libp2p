...
### <a name="type-libp2p_peer_list_pb">libp2p_peer_list_pb()</a> ###


<pre><code>
libp2p_peer_list_pb() = #libp2p_peer_list_pb{}
</code></pre>




### <a name="type-libp2p_peer_pb">libp2p_peer_pb()</a> ###


<pre><code>
libp2p_peer_pb() = #libp2p_peer_pb{}
</code></pre>




### <a name="type-libp2p_signed_peer_pb">libp2p_signed_peer_pb()</a> ###


<pre><code>
libp2p_signed_peer_pb() = #libp2p_signed_peer_pb{}
</code></pre>
...
<pre><code>
nat_type() = none | static | restricted | symmetric | unknown
</code></pre>
...
<pre><code>
encode_msg(Msg::#libp2p_peer_pb{} | #libp2p_signed_peer_pb{} | #libp2p_peer_list_pb{}) -&gt; binary()
</code></pre>
<br />
...
<pre><code>
encode_msg(Msg::#libp2p_peer_pb{} | #libp2p_signed_peer_pb{} | #libp2p_peer_list_pb{}, Opts::list()) -&gt; binary()
</code></pre>
<br />
...
<a name="enum_symbol_by_value_nat_type-1"></a>

### enum_symbol_by_value_nat_type/1 ###

`enum_symbol_by_value_nat_type(X1) -> any()`
...
<a name="enum_value_by_symbol_nat_type-1"></a>

### enum_value_by_symbol_nat_type/1 ###

`enum_value_by_symbol_nat_type(X1) -> any()`

...
dfp_read_field_def_libp2p_identify_pb(<<18,
					Rest/binary>>,
				      Z1, Z2, F1, F2, F3, F4, F5, F6,
				      TrUserData) ->
    d_field_libp2p_identify_pb_publicKey(Rest, Z1, Z2, F1,
...
dfp_read_field_def_libp2p_identify_pb(<<42,
					Rest/binary>>,
				      Z1, Z2, F1, F2, F3, F4, F5, F6,
				      TrUserData) ->
    d_field_libp2p_identify_pb_protocols(Rest, Z1, Z2, F1,
					 F2, F3, F4, F5, F6, TrUserData);
dfp_read_field_def_libp2p_identify_pb(<<50,
    ...
    d_field_libp2p_identify_pb_agent_version(Rest, Z1, Z2,
					     F1, F2, F3, F4, F5, F6,
					     TrUserData);
dfp_read_field_def_libp2p_identify_pb(<<>>, 0, 0, F1,
				      F2, F3, F4, F5, F6, TrUserData) ->
    #libp2p_identify_pb{protocol_version = F1,
			publicKey = F2,
			listen_addrs = lists_reverse(F3, TrUserData),
			observed_addr = F4,
			protocols = lists_reverse(F5, TrUserData),
			agent_version = F6};
dfp_read_field_def_libp2p_identify_pb(Other, Z1, Z2, F1,
				      F2, F3, F4, F5, F6, TrUserData) ->
    dg_read_field_def_libp2p_identify_pb(Other, Z1, Z2, F1,
					 F2, F3, F4, F5, F6, TrUserData).
...
dg_read_field_def_libp2p_identify_pb(<<0:1, X:7,
    ...
    case Key of
	  ...
	  d_field_libp2p_identify_pb_protocol_version(Rest, 0, 0,
						      ...
						      TrUserData);
      18 ->
	  d_field_libp2p_identify_pb_publicKey(Rest, 0, 0, F1, F2,
					       F3, F4, F5, F6, TrUserData);
      26 ->
	  d_field_libp2p_identify_pb_listen_addrs(Rest, 0, 0, F1,
						  F2, F3, F4, F5, F6,
						  TrUserData);
      34 ->
	  d_field_libp2p_identify_pb_observed_addr(Rest, 0, 0, F1,
						   F2, F3, F4, F5, F6,
						   TrUserData);
      42 ->
	  d_field_libp2p_identify_pb_protocols(Rest, 0, 0, F1, F2,
					       F3, F4, F5, F6, TrUserData);
      50 ->
	  d_field_libp2p_identify_pb_agent_version(Rest, 0, 0, F1,
						   F2, F3, F4, F5, F6,
						   TrUserData);
      _ ->
	  case Key band 7 of
	    0 ->
		skip_varint_libp2p_identify_pb(Rest, 0, 0, F1, F2, F3,
					       F4, F5, F6, TrUserData);
	    1 ->
		skip_64_libp2p_identify_pb(Rest, 0, 0, F1, F2, F3, F4,
					   F5, F6, TrUserData);
	    2 ->
		skip_length_delimited_libp2p_identify_pb(Rest, 0, 0, F1,
							 F2, F3, F4, F5, F6,
							 TrUserData);
	    3 ->
		skip_group_libp2p_identify_pb(Rest, Key bsr 3, 0, F1,
					      F2, F3, F4, F5, F6, TrUserData);
	    5 ->
		skip_32_libp2p_identify_pb(Rest, 0, 0, F1, F2, F3, F4,
					   F5, F6, TrUserData)
	  end
    end;
dg_read_field_def_libp2p_identify_pb(<<>>, 0, 0, F1, F2,
				     F3, F4, F5, F6, TrUserData) ->
    #libp2p_identify_pb{protocol_version = F1,
			publicKey = F2,
			listen_addrs = lists_reverse(F3, TrUserData),
...
d_field_libp2p_identify_pb_protocol_version(<<0:1, X:7,
    ...
    dfp_read_field_def_libp2p_identify_pb(Rest2, 0, 0,
...
d_field_libp2p_identify_pb_publicKey(<<0:1, X:7,
    ...
    dfp_read_field_def_libp2p_identify_pb(Rest2, 0, 0, F1,
...
skip_varint_libp2p_identify_pb(<<1:1, _:7,
    ...
    skip_varint_libp2p_identify_pb(Rest, Z1, Z2, F1, F2, F3,
				   F4, F5, F6, TrUserData);
skip_varint_libp2p_identify_pb(<<0:1, _:7,
				 Rest/binary>>,
			       Z1, Z2, F1, F2, F3, F4, F5, F6, TrUserData) ->
    dfp_read_field_def_libp2p_identify_pb(Rest, Z1, Z2, F1,
					  F2, F3, F4, F5, F6, TrUserData).
...
skip_group_libp2p_identify_pb(Bin, FNum, Z2, F1, F2, F3,
			      F4, F5, F6, TrUserData) ->
    {_, Rest} = read_group(Bin, FNum),
    dfp_read_field_def_libp2p_identify_pb(Rest, 0, Z2, F1,
					  F2, F3, F4, F5, F6, TrUserData).
